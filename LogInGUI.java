...
public class LogInGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hhCodeField.setToolTipText("Enter your household code here");
        hhCodeField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                hhCodeFieldActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(hhCodeField, javax.swing.GroupLayout.DEFAULT_SIZE, 190, Short.MAX_VALUE)
    ...
    private void logInButtonActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        //Account acc = dbh.getAccount(hhc);
        Account acc = new Account();//del
        Member mem = acc.getMember(dn);
        if (acc != null && acc.hasMember(dn))
        {
            this.dispose();
            DashboardGUI dashboard = new DashboardGUI(acc, mem);
            dashboard.setVisible(true);
        }
        else
        {
            errorLabel.setText("Invalid display name or household code");
        }
    }                                           

    private void hhCodeFieldActionPerformed(java.awt.event.ActionEvent evt) {                                            
        // TODO add your handling code here:
        errorLabel.setText("");
        logInButtonActionPerformed(evt);
    }                                           
