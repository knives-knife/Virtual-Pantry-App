...
public class FridgeGUI extends javax.swing.JFrame {
    ...
    public FridgeGUI() {
        initComponents();
        botBanFridgeButton.setEnabled(false);
    }
    public FridgeGUI(Account acc) {
        initComponents();
        account = acc;
        botBanPantryButton.setEnabled(false);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FridgeGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
