...
//    private Recipes[] recipes;
    ...
    public DashboardGUI(Account acc, Member mem)
    {
        ...
        String[] pantry = dbh.getPantry();
        String[] fridge = dbh.getFridge();
        expDateLabel.setText(pantry[0]);
        expItemLabel.setText(fridge[0]);

        //get the pantry items and fridge items of the account
//        Item[] pantry = dbh.getPantry();
...
//        setRecipeButtons(rdbh.getRecipes())
